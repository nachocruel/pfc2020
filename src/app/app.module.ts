...
import { CondominioSelectComponent } from './Layout/Components/header/elements/condominio-select/condominio-select.component'
...
@NgModule({
  ...
  imports: [
    AgmCoreModule.forRoot({
      apiKey: 'AIzaSyDLdScwDJ0iuH7oLlR9ilSMQx6Ni4b2XVQ'
    }),
    BrowserModule,
    AppRoutingModule,
