...
export class CondominioSelectComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.http.get('https://pfc2020-api.herokuapp.com/api/pais').subscribe((countries)=>{   
        ...
        this.http.post('https://pfc2020-api.herokuapp.com/api/device/get_lista_especifica', 
           {
