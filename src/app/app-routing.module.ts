...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: 'user/create', component:CreateUserComponent, data:{extraParameter:"createUser"}},


      //Country

      {path:'country/create', component:CreatePaisComponent, data: {extraParameter:"createCountry"}},

      {path: 'device/edit', component:EditDeviceComponent, data: {extraParameter:"editDevice"}},
      // Elements
